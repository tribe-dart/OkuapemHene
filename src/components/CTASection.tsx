  ...
  return (
    <section className="relative py-24 bg-navy overflow-hidden">
      <Image
        ...
        alt="Akuapem community gathering"
        fill
        className="object-cover opacity-15"
      />
      <div className="absolute inset-0 bg-gradient-to-br from-navy via-navy-light/90 to-charcoal/90" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 text-center">
        ...
        <h2 className="font-serif text-4xl sm:text-5xl font-bold text-white mt-4 mb-6">
          Be Part of{" "}
          <span className="text-gold">Akuapem&apos;s Transformation</span>
        </h2>
